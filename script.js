...
const nama_yang_ngirim = "Baginda Faiq Naufal"

// nama
const nama = "ACELL ASU"

// yang ini biarin aja
let n = 0
const link_wa = `https://api.whatsapp.com/send?text=THANKS COKKK ${nama_yang_ngirim}&phone=${nomor_hp_yang_ngirim}`
nm.textContent = nama
...
const kata = [
  `NIH BUAT LO ${nama}`,
  `Jaga kesehatan yaaa masbro`,
  `Istirahat yg cukup yah ${nama}`,
  `Jangan terlalu stress mikirin industri`,
  `Perbanyak tidur ${nama}`
]
